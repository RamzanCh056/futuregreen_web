...
extension DebugPrint on dynamic {
  dynamic get showMessage => dev.log(toString(), name: "Message");
  dynamic get showError => dev.log('', name: "Error", error: toString());
}

// Apply Flexible Widget
extension ApplyFlexible on Widget {
...
/// if the String is either null or empty.
extension PopScreens on int {
  void get pop => Get.close(this);
}

/// Returns `1,233,15` if the String is '123315'.
// extension CurrencyWithCommas on String {
//   String get currencyWithCommas =>
...
extension HorizontalPadding on Widget {
  Widget paddingHrz(double padding) => Padding(
...
extension VerticalPadding on Widget {
  Widget paddingVert(double padding) => Padding(
...
// Padding All
extension AllSidePadding on Widget {
...
// Padding LEFT
extension LeftSidePadding on Widget {
  Widget paddingL(double padding) => Padding(
...
// Padding RIGHT
extension RightSidePadding on Widget {
  Widget paddingR(double padding) => Padding(
...
// Padding TOP
extension TopSidePadding on Widget {
  Widget paddingT(double padding) => Padding(
...
// Padding Bottom
extension BottomSidePadding on Widget {
  Widget paddingB(double padding) => Padding(
        padding: EdgeInsets.only(bottom: padding),
        child: this,
      );
}

extension GetHeight on num {
  double get h => this * Get.height / 100;
}

extension GetWidth on num {
...
mixin Ex {
  ...
  ///  border radius 7.5
  static BorderRadiusGeometry roundedSm = BorderRadius.circular(7.5);

  /// border radius 15
  static BorderRadiusGeometry rounded = BorderRadius.circular(15);

  /// border radius 30
  static BorderRadiusGeometry roundedLg = BorderRadius.circular(30);

  /// custom border radius
  static BorderRadiusGeometry roundedWith(double radius) =>
